    ...
    <Box sx={{ display: "flex", bgcolor: "#0b1020", color: "#e7ecff", minHeight: "100dvh" }}>
      ...
      >
        <Toolbar>
          <Typography variant="h6" sx={{ flex: 1 }}>
            <Link to="/dashboard/client" style={{ color: "#e7ecff", textDecoration: "none" }}>
              Client Console
            </Link>
          </Typography>
      ...
      >
        ...
        <Box sx={{ overflow: "auto", pt: 1 }}>
          <List>
            <Item to="/dashboard/client" icon={<HomeIcon />} label="Overview" />
            <Item to="/dashboard/client/formulaires" icon={<DescriptionIcon />} label="Formulaires" />
            <Item to="/dashboard/client/help" icon={<HelpCenterIcon />} label="Help" />
          </List>
        </Box>
      </Drawer>
